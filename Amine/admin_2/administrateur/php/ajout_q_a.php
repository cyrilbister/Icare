...
<form action="validation_ajout_q_a.php" method="post">
<h1 class="titre">Ajouter Q&A</h1>

<div class="champs">
    <input type="text"  name ="question" class="question_reponse" placeholder="Veuillez saisir votre question">
    <hr>

    <input type="text"  name ="reponse" class="question_reponse" placeholder="Veuillez saisir la réponse à votre question">
</div>
<hr>
