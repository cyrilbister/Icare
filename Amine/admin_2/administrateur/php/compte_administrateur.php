...
<form method="POST" action="validation_compte.php">
    <p class="titre">
    ...
    <div class="container" id="un">
        <section>
            ...
            <hr>
            <label for="numéro de téléphone">Numéro de téléphone</label><br /> <input type="tel" id="numéro de téléphone" name="num_de_tel_inc" required><br />
            <hr>
    ...
    <div class="container" id="deux">
        <label for="pass1">Mot de passe</label><br /> <input type="password" id="pass1" name="pass1_inc" class="pass1" required/><br />
        <hr>
        <label for="pass2">Mot de passe<span class="petit"> (vérification)</span></label><br /> <input type="password" id="pass2" name="pass2_inc" class="pass2" required/><br />
        <hr>
    </div>
